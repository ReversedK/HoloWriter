...
export default class HoloJs {
    ...
    if(!this.collection_addr.length)  this.collection_addr = await this.create_collection(this.collection_name);
    ...
    /*************************** */
    async get(addr) {
        let payload = { item_addr: addr };
        return await this.callHoloInstance('collections', 'get_item',payload);
    }
